...
void Motor_Stop(void){
   //your code here
    // Clear the PWM outputs to stop the motors
     TA0CCR3 = 0;               // Set right motor duty cycle to 0
     TA0CCR4 = 0;               // Set left motor duty cycle to 0
     P3OUT &= ~RIGHT_MOT_SLEEP; // Put right motor to sleep
     P3OUT &= ~LEFT_MOT_SLEEP;  // Put left motor to sleep
     return;
